...
const TABS = [
  ...
  { href: "/vendor/earnings", label: "Earnings", icon: BanknoteArrowUp },
          ...
          <div className="ml-auto flex items-center gap-3">
            <div className="flex items-center gap-2.5">
              <div className="text-right">
                ...
                >
                  {open ? "Taking orders" : "Closed"}
                </p>
                {!open && autoClosed ? (
                  <p className="mt-1 text-[11px] leading-none text-amber">Auto-closed</p>
                ) : null}
              </div>
              <Switch
                checked={open}
        ...
        {!open && autoClosed ? (
          <div className="border-t border-amber/30 bg-amber-wash px-4 py-2">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-2 text-xs text-amber">
              ...
              <span>
                Three orders were not answered today, so TREFOOD stopped sending you more.
                Flip the switch above when someone is at the tablet again.
              </span>
            </div>
          </div>
        ) : null}
